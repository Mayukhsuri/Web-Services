...
public class Customerclient {
    ...
    public static void main(String args[]) throws Exception {
       ...
       //Configuring the CXF logging interceptor for the incoming response
         ...
         getClient = getClient.accept("application/json").type("application/json").path("/customerservice/customer/1001");
        ...
        *****************************************************************************************/
        ...
        customerRequest.setFirstName("Mayukh");
        customerRequest.setLastName("Suri");
